...
BLOG_AUTHOR = "Juho Härme"  # (translatable)
BLOG_TITLE = "NotSoTechnical"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://hrmJ.github.io/blog/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://hrmJ.github.io/blog/"
BLOG_EMAIL = "juho.harme@gmail.com"
BLOG_DESCRIPTION = "Writing a phd with markdown in the humanities - and other notes from a wannabe developer"  # (translatable)
...
# is in the manual.
COMMENT_SYSTEM_ID = "notsotechnical"
